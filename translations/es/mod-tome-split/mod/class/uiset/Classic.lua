-- mod-tome/mod/class/uiset/Classic.lua
-- Total: 20 cadenas
-- Estado: ⏳ Pendiente
...
t("Inventory (#{bold}##GOLD#%s#LAST##{normal}#)", "Inventario%s", "tformat")
t("#{bold}##GOLD#C#LAST##{normal}#haracter Sheet", "################################################################################################################################################################################################################################################################", "_t")
t("Character Sheet (#{bold}##GOLD#%s#LAST##{normal}#)", "Hoja de caracteres (#{bold}##            ##{normal}#)%s", "tformat")
t("Main menu (#{bold}##GOLD#%s#LAST##{normal}#)", "Menú principal (#{bold}###  %s ##{normal}#)", "tformat")
t("Show message/chat log (#{bold}##GOLD#%s#LAST##{normal}#)", "Mostrar mensaje/chat log (#{bold}###  %s###{normal}#", "tformat")
t("Cosmetics & Events shop (#{bold}##GOLD#%s#LAST##{normal}#, #{bold}##GOLD#%s#LAST##{normal}#)", "Cosmetics & Events shop (#{bold}###   %s##{normal}#, #{bold}#####           ##{normal}#%s", "tformat")
