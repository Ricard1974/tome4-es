...
t("#LIGHT_BLUE#%s: %s#LAST#", "#LIGHT BLUE# %s    %s #LAST#", "logPlayer")
t("Success", "Éxito", "_t")
t("Failure", "Fallo", "_t")
t(" #LIGHT_BLUE#Trap Description:#WHITE# ", "#LIGHT BLUE#Trap Descripción:#WHITE#", "_t")
...
t("dodge", "esquivar", "_t")
t("#CADET_BLUE#You %s a trap (%s).", "#CADET BLUE#You  %s    una trampa ( %s  ).", "log")
t("#CADET_BLUE#%s %ss %s.", "#CADET BLUE#%s                                                                                                                                                                                                                                                     .%s%s", "logSeen")
