-- mod-tome/mod/class/interface/PartyDeath.lua
-- Total: 19 cadenas
-- Estado: ⏳ Pendiente
...
t("%s the level %d %s %s was %s to death by %s%s%s on level %s of %s.", "%s.%d%s%s%s%s%s%s%s%s", "tformat")
t("battered", "estropeado", "_t")
t(" (yet again)", "(otra vez)", "_t")
t("%s(%d %s %s) was %s to death by %s%s on %s %s.", "%s.%d%s%s%s%s%s%s%s", "tformat")
t("%s the level %d %s %s %s on level %s of %s.", "%s.%d%s%s%s%s%s", "tformat")
t("%s(%d %s %s) %s on %s %s.", "%s.%d%s%s%s%s%s", "tformat")
t("#{bold}#", "# {bold}#", "_t")
