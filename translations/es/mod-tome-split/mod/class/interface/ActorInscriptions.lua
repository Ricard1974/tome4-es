-- mod-tome/mod/class/interface/ActorInscriptions.lua
-- Total: 5 cadenas
-- Estado: ⏳ Pendiente
...
t("You are now inscribed with %s.", "Ahora está inscrito con  %s .", "logPlayer")
t("Your %s is depleted!", "¡Tu  %s  está agotada!", "logPlayer")
