...
t("Talent on hit(spell): %s (%d%% chance level %d).", "Talento on hit(spell):  %s   ( %d%% chance level  %d  ).", "tformat")
t("Talent on hit(nature): %s (%d%% chance level %d).", "Talento on hit(nature):  %s   ( %d %% chance level  %d ).", "tformat")
t("Talent on hit(mindpower): %s (%d%% chance level %d).", "Talento on hit(mindpower):  %s   ( %d %% chance level  %d ).", "tformat")
