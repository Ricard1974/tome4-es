...
t("When this weapon hits: %s (%d%% chance level %d).", "Cuando este arma golpea:  %s      %%% nivel de probabilidad  %d  ).%d", "tformat")
t("When this weapon crits: %s (%d%% chance level %d).", "Cuando este arma crits:  %s        %% nivel de probabilidad  %d  ).%d", "tformat")
