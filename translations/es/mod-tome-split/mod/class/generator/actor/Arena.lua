...
t("Multi-hued Wyrmic", "Dracónico Multicolor", "_t")
...
t("#LIGHT_RED#%s%s", "#LIGHT RED #                                                                                                %s%s", "log")
t("#LIGHT_RED#WARNING! %s appears!!!", "#LIGHT RED #WARNING!  %s aparece!", "log")
...
t("#LIGHT_RED#WARNING! %s, the master of the arena, appears!!!", "#LIGHT RED#WARNING!  %s , el maestro de la arena, aparece!!!", "log")
t("OVERKILL", "SOBREMATAR", "_t")
t("#LIGHT_GREEN#Your powerful attack completely obliterates #WHITE#%s#LIGHT_GREEN#!", "#LIGHT GREEN# Your powerful attack completely obliterates #WHITE#%s  #LIGHT GREEN#!", "log")
t("#LIGHT_GREEN#The audience cheers!", "¡La audiencia anima!", "log")
t("#LIGHT_GREEN#You destroy #WHITE#%s#LIGHT_GREEN# in a single blow!", "#LIGHT GREEN# You destroy #WHITE# %s #LIGHT GREEN# in a single blow!", "log")
t("#LIGHT_GREEN#Your score multiplier increases by #WHITE#%d#LIGHT_GREEN#!", "#LIGHT GREEN #Tu multiplicador de puntuación aumenta por #WHITE#%d   #LIGHT GREEN#!", "log")
