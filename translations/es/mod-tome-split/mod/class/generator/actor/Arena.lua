...
t("#LIGHT_GREEN#Your score multiplier increases by #WHITE#0.1#LIGHT_GREEN#!", "#LIGHT GREEN #Tu multiplicador de puntuación aumentas por #WHITE#0.1#LIGHT_GREEN#!", "log")
