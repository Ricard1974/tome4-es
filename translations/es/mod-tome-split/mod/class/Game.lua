...
t("#Source# hits #Target# for %s (#RED##{bold}#%0.0f#LAST##{normal}# total damage)%s.", "#Source # #Source# hits #Target# for %s (#RED##{bold}#%0.0f####{normal}# total damage)%s.", "logMessage")
t(" #LIGHT_GREEN#[%0.0f healing]#LAST#", "#LIGHT_GREEN# ########################################################################################################################################################################################################################################################%0.0f", "tformat")
