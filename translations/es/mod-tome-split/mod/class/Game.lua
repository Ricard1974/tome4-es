...
t("#LIGHT_RED#You may not change level so soon after a kill (%d game turns left to wait)!", "#LIGHT RED#Usted no puede cambiar el nivel tan pronto después de un asesinato ( %d  juego gira a la izquierda a esperar)!", "logPlayer")
...
t("You may not auto-explore with enemies in sight (%s to the %s%s)!", "Usted no puede autoexplorar con enemigos a la vista ( %s                    )!%s%s", "log")
...
t("You cannot go into the wilds with the following effects: %s", "Usted no puede entrar en los salvajes con los siguientes efectos:  %s ", "log")
...
t("#ANTIQUE_WHITE#Splash screen unlocked: #GOLD#%s", "#ANTIQUE WHITE#Splash screen desbloqueado: #GOLD# %s  ", "log")
