-- mod-tome/mod/class/EscortRewards.lua
-- Total: 30 cadenas
-- Estado: ⏳ Pendiente
...
t("%s, the lost warrior", "El guerrero perdido%s", "_t")
...
t("%s, the injured seer", "El vidente herido%s", "_t")
t("She looks tired and wounded.", "Parece cansada y herida.", "_t")
t("%s, the repented thief", "%s , el ladrón arrepentido", "_t")
t("%s, the lone alchemist", "El alquimista solitario%s", "_t")
t("%s, the lost sun paladin", "%s , el paladín del sol perdido", "_t")
t("%s, the lost defiler", "El desfilador perdido%s", "_t")
t("temporal portal", "portal temporal", "_t")
t("%s, temporal explorer", "%s  , explorador temporal", "_t")
...
t("%s, the worried loremaster", "%s  , el dueño de la casa", "_t")
...
t("improved %s by +%d", "mejorado  %s  por + %d ", "tformat")
t("[Improve %s by +%d]", "[Mejor  %s   por + %d ]", "tformat")
t("improved %s save by +%d", "mejorado  %s  Guardar por + %d ", "tformat")
t("[Improve %s save by +%d]", "[Mejor  %s   Guardar por + %d  ]", "tformat")
t("%s talent %s (+%d level(s))", "%s   talento  %s   (+ %d   nivel(s))", "tformat")
t("improved", "mejorado", "_t")
t("learnt", "aprender", "_t")
t("[%s talent %s (+%d level(s))]", "[ %s   talento  %s   (+ %d    nivel(s)]", "tformat")
t("Improve", "Mejora", "_t")
t("Learn", "Aprender", "_t")
t("gained talent category %s (at mastery %0.2f)", "la categoría de talento adquirido  %s  (en mastery  %0.2f )", "tformat")
t("[Allow training of talent category %s (at mastery %0.2f)]", "[Permitir el entrenamiento de la categoría de talento  %s   (en mastery  %0.2f  )]", "tformat")
