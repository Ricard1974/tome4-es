-- mod-tome/mod/dialogs/GraphicMode.lua
-- Total: 21 cadenas
-- Estado: ⏳ Pendiente
...
t("Select style [current: %s]", "Seleccionar estilo [current: %s ]", "tformat")
t("Select tiles size [current: %s]", "Seleccione el tamaño de los azulejos [currente: %s ]", "tformat")
t("64x64", "64x64", "_t")
t("48x48", "48x48", "_t")
t("32x32", "32x32", "_t")
t("16x16", "16x16", "_t")
t("Custom", "Personalizado", "_t")
