-- mod-tome/mod/dialogs/TrapsSelect.lua
-- Total: 16 cadenas
-- Estado: ⏳ Pendiente
...
t(" (%s)", "( %s )", "tformat")
t("%s) Tier %d: %s%s", "%s                                                                                                                                                                                                                                                           %d%s%s", "tformat")
...
t("#LIGHT_BLUE#You cannot prepare more than %d traps.", "No puedes preparar más que trampas.%d", "logPlayer")
