-- mod-tome/mod/dialogs/WandererSeed.lua
-- Total: 8 cadenas
-- Estado: ⏳ Pendiente
...
t("Simply make a random set of trees, this is the default option. If you want to share it with friends, you will find the seed in the character's sheet later on.", "Simplemente haga un conjunto aleatorio de árboles, esta eres la opción predeterminada. Si quieres compartirlo con amigos, encontrarás la semilla en la hoja del personaje más adelante.", "_t")
...
t("Play!", "¡Juega!", "_t")
t("#{bold}##ANTIQUE_WHITE#Random#{normal}##LAST#", "#{bold}##ANTIQUE_WHITE#Aleatorio#{normal}##LAST#", "_t")
t("#{bold}##ANTIQUE_WHITE#Seed#{normal}##LAST#", "#{bold}##ANTIQUE_WHITE#Semilla#{normal}##LAST#", "_t")
