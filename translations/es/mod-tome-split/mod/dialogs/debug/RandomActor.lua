-- mod-tome/mod/dialogs/debug/RandomActor.lua
-- Total: 27 cadenas
-- Estado: ⏳ Pendiente
-- Ultima actualizacion: --
-- Traductor: --

t("#LIGHT_GREEN#(From %s, line %s):#LAST#", "#LIGHT GREEN#(De  %s   , line  %s    )#", "tformat")
t("DEBUG -- Create Random Actor", "DEBUG -- Crear Actor Aleatorio", "_t")
t("#GREY#None#LAST#", "#GREY#None#LAST#", "_t")
t("Current Base Actor: %s", "Base actual Actor:  %s ", "tformat")
t("Generate", "Generar", "_t")
t("#LIGHT_BLUE# Current base actor: %s", "#LIGHT BLUE# Current base actor:  %s ", "log")
t("Place", "Lugar", "_t")
...
t("#LIGHT_BLUE# Clear base actor: %s", "#LIGHT BLUE# Clear base actor:  %s ", "log")
...
t("Current Boss Actor: %s", "Jefe Actor actual:  %s ", "tformat")
...
t("#LIGHT_BLUE#Inspect [%s]%s", "#LIGHT BLUE#Inspect [ %s                                                                                                                                                                                                                                                 %s", "log")
t("#LIGHT_BLUE#No actor to inspect", "#LIGHT BLUE#Ningún actor para inspeccionar", "log")
t("#LIGHT_BLUE#Lua Inspect [%s]%s", "#LIGHT BLUE#Lua Inspect [ %s              %s", "log")
t("#LIGHT_BLUE#No actor to Lua inspect", "#LIGHT BLUE#Ningún actor a Lua inspect", "log")
t("#LIGHT_BLUE#Bad filter for base actor: %s", "#LIGHT BLUE#Bad filter for base actor:  %s ", "log")
t("#LIGHT_BLUE#Could not generate a base actor with filter: %s", "#LIGHT BLUE#No podría generar un actor de base con filtro:  %s ", "log")
t("#LIGHT_BLUE#Bad data for random boss actor: %s", "#LIGHT BLUE#Bad data for random boss actor:  %s ", "log")
t("#LIGHT_BLUE#Could not generate a base actor with data: %s", "#LIGHT BLUE#No podría generar un actor de base con datos:  %s ", "log")
