-- mod-tome/mod/dialogs/debug/CreateItem.lua
-- Total: 31 cadenas
-- Estado: ⏳ Pendiente
...
t("Object could not be resolved/identified.", "El objeto no puedes ser resuelto o identificado.", "_t")
t("#LIGHT_BLUE#Could not add object to %s at (%d, %d)", "#LIGHT_BLUE#No se puede añadir objeto a %s en ( %d, %d )", "log")
t("#LIGHT_BLUE#No creature to add object to at (%d, %d)", "#LIGHT_BLUE#Ninguna criatura a la que añadir objeto a ( %d, %d )", "log")
t("#LIGHT_BLUE#No object to create", "#LIGHT_BLUE#Ningún objeto para crear", "log")
t("Place Object", "Objeto", "_t")
t("Place the object where?", "¿Dónde estás el objeto?", "_t")
t("Inventory of %s%s", "Inventario de %s %s", "tformat")
t(" #LIGHT_GREEN#(player)#LAST#", "#LIGHT_GREEN# (jugador)#", "_t")
t("Drop @ (%s, %s)%s", "Suelta @ (%s, %s ) %s", "tformat")
...
t("#LIGHT_BLUE#OBJECT:#LAST# %s%s: #LIGHT_BLUE#[%s] %s {%s, slot %s} at (%s, %s)#LAST#", "#LIGHT_BLUE#OBJECT:#LAST# %s %s%s%s%s%s%s%s", "log")
t("Number of items to make", "Número de artículos para hacer", "_t")
t("Enter 1-100%s", "Entrar 1-100 %s", "tformat")
...
t("#LIGHT_BLUE#Created %s", "#LIGHT_BLUE#Creado %s", "log")
...
t("#LIGHT_BLUE#Creating All Artifacts.", "#LIGHT_BLUE#Creando todos los artefactos.", "log")
