...
t("Attach Tinker", "Colocar Ingenio", "_t")
...
t("#GREY#None#LAST#", "#GREY#Ninguno#LAST#", "_t")
t("%s: %s", "%s %s", "tformat")
t("Object", "Objeto", "_t")
...
t("#LIGHT_BLUE#Base Object#LAST#", "#LIGHT_BLUE#Objeto Base#LAST#", "_t")
...
t("#ORANGE#Randart#LAST#", "#ORANGE#Artefacto Aleatorio#LAST#", "_t")
...
t("#GREY#No Tooltip to Display#LAST#", "#GREY#Sin Información que Mostrar#LAST#", "_t")
