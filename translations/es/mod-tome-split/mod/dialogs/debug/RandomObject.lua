...
t("#LIGHT_GREEN#(From %-10.60s, line: %s):#LAST#", "#LIGHT GREEN#(De %-10.60s, line:  %s  ):#", "tformat")
...
t("#LIGHT_BLUE#Bad %s: %s", "#LIGHT BLUE#Bad  %s    %s ", "log")
t("table definition", "definición", "_t")
t("#LIGHT_BLUE# Generate Random object using resolver: %s", "#LIGHT BLUE# Generar objeto aleatorio mediante resolución:  %s ", "log")
t("#LIGHT_BLUE# New random%s object: %s", "#LIGHT BLUE# New random %s   object:  %s ", "log")
t(" (resolver: %s)", "(resolver:  %s )", "tformat")
t("#LIGHT_BLUE#Could not generate a random object with filter: %s", "#LIGHT BLUE#No puede generar un objeto aleatorio con filtro:  %s ", "log")
t("#LIGHT_BLUE#Could not generate a base object with filter: %s", "#LIGHT BLUE#No puede generar un objeto base con filtro:  %s ", "log")
t("#LIGHT_BLUE#Could not generate a Randart with data: %s", "#LIGHT BLUE#No podría generar un Randart con datos:  %s ", "log")
t("#LIGHT_BLUE#No object to add", "#LIGHT BLUE#No hay objeto que añadir", "log")
t("#LIGHT_BLUE#Working Actor set to [%s]%s at (%d, %d)", "#LIGHT BLUE#Working Actor set to [ %s                                 %s%d%d", "log")
