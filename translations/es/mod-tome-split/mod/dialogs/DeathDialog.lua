-- mod-tome/mod/dialogs/DeathDialog.lua
-- Total: 21 cadenas
-- Estado: ⏳ Pendiente
...
t("Resurrect by consuming %s", "Resurrecto consumiendo  %s ", "tformat")
t("Resurrect with Adventurer Mode (%d life(s) left)", "Resurrecta con Modo de Aventura ( %d    vida(s) izquierda)", "tformat")
