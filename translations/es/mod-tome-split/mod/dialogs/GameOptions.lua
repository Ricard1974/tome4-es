...
t("Sides", "Lados", "_t")
t("Bottom", "Abajo", "_t")
t("If disabled you will not get a fullscreen notification of stun/daze effects. Beware.#WHITE#", "Si estás deshabilitado no recibirá una notificación de pantalla completa de los efectos de aturdimiento/aturdimiento. Cuidado", "_t")
t("#GOLD##{bold}#Fullscreen stun/daze notification#WHITE##{normal}#", "#GOLD##{bold}#Notificación de aturdimiento a pantalla completa#WHITE##{normal}#", "_t")
...
t("#GOLD##{bold}#Always show glove combat properties#WHITE##{normal}#", "#GOLD##{bold}#Mostrar propiedades de guantes#WHITE##{normal}#", "_t")
...
t("#GOLD##{bold}#Always show shield combat properties#WHITE##{normal}#", "#GOLD##{bold}#Mostrar propiedades de escudos#WHITE##{normal}#", "_t")
...
t("#GOLD##{bold}#Quick melee targeting auto attack#WHITE##{normal}#", "#GOLD##{bold}#Ataque automático cuerpo a cuerpo rápido#WHITE##{normal}#", "_t")
...
t("yes", "sí", "_t")
t("no", "no", "_t")
t("#GOLD##{bold}#Save in the background#WHITE##{normal}#", "#GOLD##{bold}#Guardar en segundo plano#WHITE##{normal}#", "_t")
t("#GOLD##{bold}#Zone save per level#WHITE##{normal}#", "#GOLD##{bold}#Guardado por nivel de zona#WHITE##{normal}#", "_t")
t("Disallow boot images that could be found 'offensive'.#WHITE#", "Desactivar imágenes de inicio que puedan resultar ofensivas.#WHITE#", "_t")
t("#GOLD##{bold}#Censor boot#WHITE##{normal}#", "#GOLD##{bold}#Censurar inicio#WHITE##{normal}#", "_t")
t("Replace headwear images by cloak hoods if a cloak is worn#WHITE#", "Reemplazar imágenes de sombreros por capuchas si se lleva una capa#WHITE#", "_t")
t("#GOLD##{bold}#Show cloak hoods#WHITE##{normal}#", "#GOLD##{bold}#Mostrar capuchas#WHITE##{normal}#", "_t")
