-- mod-tome/mod/dialogs/UseItemDialog.lua
-- Total: 24 cadenas
-- Estado: ⏳ Pendiente
...
t("1 to %d", "1 a %d", "tformat")
t("Attach to item", "Adjuntar el elemento", "_t")
t("You do not have any equipped items that it can be attached to.", "Tú no tienes elementos equipados a los que se puede adjuntar.", "_t")
t("Select which item to attach it to:", "Seleccione qué elemento para adjuntarlo a:", "_t")
t("Really %s %s", "¿En serio%s%s", "tformat")
