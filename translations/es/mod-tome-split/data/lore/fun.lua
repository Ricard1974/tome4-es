...
t("misc", "varios", "newLore category")
t("trollish poem", "poema trollish", "_t")
t("necromancer poem", "poema de necromancer", "_t")
t("how to be a necromancer, part 1", "como ser un necromancer, parte 1", "_t")
t("how to be a necromancer, part 2", "como ser un necromancer, parte 2", "_t")
