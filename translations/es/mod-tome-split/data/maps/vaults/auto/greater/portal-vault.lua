-- mod-tome/data/maps/vaults/auto/greater/portal-vault.lua
-- Total: 10 cadenas
-- Estado: ⏳ Pendiente
...
t("Malevolent Portal", "Portal Malévolo", "_t")
...
t("#YELLOW#You overcome intense #LIGHT_BLUE#REPULSIVE FORCES#LAST# as you traverse the Portal.", "#YELLOW#You overcome intense #LIGHT_BLUE#REPULSIVE_FORCES#LAST# mientras atraviesas el Portal.", "logPlayer")
