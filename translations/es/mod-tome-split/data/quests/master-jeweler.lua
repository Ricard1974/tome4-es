-- mod-tome/data/quests/master-jeweler.lua
-- Total: 10 cadenas
-- Estado: ⏳ Pendiente
-- Ultima actualizacion: --
-- Traductor: --

t("Lost Knowledge", "Conocimiento Perdido", "_t")
...
t("Limmir points to the entrance to a cave on your map. This is supposed to be the way to the valley.", "Limmir apunta a la entrada de una cueva en tu mapa. Se supone que este eres el camino al valle.", "logPlayer")
...
t("Limmir (Quest)", "Limmir (Misión)", "_t")
