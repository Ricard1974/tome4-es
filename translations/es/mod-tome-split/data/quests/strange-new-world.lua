-- mod-tome/data/quests/strange-new-world.lua
-- Total: 9 cadenas
-- Estado: ⏳ Pendiente
...
t("Upon arrival you met an Elf and an orc fighting.", "A tu llegada se encontró con un Elf y un orc peleando.", "_t")
...
t("%s go to the west, and find Kruk Pride!", "%s ir al oeste, y encontrar Kruk Pride!", "tformat")
t("%s go to the southeast, and tell Aeryn what happened to me!", "%s ir al sureste, y decirle a Aeryn lo que me pasó!", "tformat")
