-- mod-tome/data/quests/east-portal.lua
-- Total: 16 cadenas
-- Estado: ⏳ Pendiente
...
t("You talked to the Elder in Last Hope who in turn told you to talk to Tannen, who lives in the north of the city.", "Hablaste con el Anciano en la Última Esperanza que a tu vez te dijo que hablaras con Tannen, que vive en el norte de la ciudad.", "_t")
...
t("You brought back the diamond and athame to Tannen who asked you to check the tower of Telmur, looking for a text of portals, although he is not sure it is even there. He told you to come back in a few days.", "Trajiste el diamante y el atoma a Tannen que te pidió que revisaras la torre de Telmur, buscando un texto de portales, aunque él no estás seguro de que esté allí. Te dijo que volvieras en unos días.", "_t")
...
t("Tannen revealed himself as the vile scum he really is and trapped you in his tower.", "Tannen se reveló como la escoria vil que realmente es y te atrapó en tu torre.", "_t")
t("", "", "_t")
