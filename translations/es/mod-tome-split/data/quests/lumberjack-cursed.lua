-- mod-tome/data/quests/lumberjack-cursed.lua
-- Total: 11 cadenas
-- Estado: ⏳ Pendiente
...
t("%d lumberjacks have died.", "Los leñadores han muerto.%d", "tformat")
...
t("Thanks", "Gracias", "_t")
t("The remaining lumberjacks collect some gold to thank you (%0.2f).", "Los leñadores restantes recogen algo de oro para agradecerle ( %0.2f ).", "tformat")
t("You saved %s of us, please take this as a reward. (They give you %s)", "Salvaste %s de nosotros, por favor, toma esto como recompensa. (Te dan %s )", "tformat")
