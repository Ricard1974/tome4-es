-- mod-tome/data/quests/shertul-fortress.lua
-- Total: 24 cadenas
-- Estado: ⏳ Pendiente
...
t("You found notes from an explorer inside the Old Forest. He spoke about Sher'Tul ruins sunken below the surface of the lake of Nur, at the forest's center.", "Tú encontró notas de un explorador dentro del Bosque Antiguo. Habló sobre las ruinas de Sher'Tul hundidas debajo de la superficie del lago de Nur, en el centro del bosque.", "_t")
...
t("#LIGHT_GREEN#* You used the key inside the ruins of Nur and found a way into the fortress of old.#WHITE#", "#LIGHT_GREEN#* Usaste la llave dentro de las ruinas de Nur y encontraste una forma de entrar en la fortaleza vieja. #WHITE#", "_t")
t("#LIGHT_GREEN#* The Weirdling Beast is dead, freeing the way into the fortress itself.#WHITE#", "#LIGHT_GREEN#* La Bestia Weirdling estás muerta, liberando el camino hacia la fortaleza misma. #WHITE#", "_t")
...
t("#LIGHT_GREEN#* You have upgraded your rod of recall to transport you to the fortress.#WHITE#", "#LIGHT GREEN # Tú ha actualizado tu vara de recuerdo para transportarlo a la fortaleza. #WHITE#", "_t")
...
t("#LIGHT_GREEN#* You have entered the exploratory farportal room and defeated the horror lurking there. You can now use the farportal.#WHITE#", "#LIGHT GREEN # Tú ha entrado en la sala de exploración farportal y derrotado el horror que se acecha allí. Ahora puedes usar el farportal. #WHITE#", "_t")
t("#LIGHT_GREEN#* You have re-enabled the fortress flight systems. You can now fly around in your fortress!#WHITE#", "#LIGHT_GREEN#* Has vuelto a habilitar los sistemas de vuelo de la fortaleza. ¡Ahora puedes volar en tu fortaleza! #WHITE#", "_t")
...
t(" The fortress's current energy level is: #LIGHT_GREEN#%d#WHITE#.", "El nivel de energía actual de la fortaleza es: #LIGHT_GREEN#%d#WHITE#.", "tformat")
