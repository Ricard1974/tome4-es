...
t("You have vanquished the masters of the Orc Pride. Now you must venture inside the most dangerous place of this world: the High Peak.", "Has vencido a los maestros del Orc Pride. Ahora tú debe aventurarse dentro del lugar más peligroso de este mundo: el pico alto.", "_t")
t("Seek the Sorcerers and stop them before they bend the world to their will.", "Busquen a los Hechiceros y detenganlos antes de doblar el mundo a tu voluntad.", "_t")
...
t("#LIGHT_GREEN#* You encountered Sun Paladin Aeryn who blamed you for the loss of the Sunwall. You were forced to kill her.#LAST#", "#LIGHT_GREEN#* Has encontrado a Sun Paladin Aeryn quien te culpó por la pérdida del Sunwall. Te obligaron a matarla. #LAST#", "_t")
t("#LIGHT_GREEN#* You encountered Sun Paladin Aeryn who blamed you for the loss of the Sunwall, but you spared her.#LAST#", "#LIGHT_GREEN#* Has encontrado a Sun Paladin Aeryn quien te culpó por la pérdida del Sunwall, pero la perdonaste. #LAST#", "_t")
t("#LIGHT_GREEN#* You defeated the Sorcerers before the Void portal could open.#LAST#", "#LIGHT_GREEN# Derrotaste a los Hechiceros antes de que el portal Void pudiera abrirse. #LAST#", "_t")
t("#LIGHT_GREEN#* You defeated the Sorcerers and Aeryn sacrificed herself to close the Void portal.#LAST#", "#LIGHT_GREEN#* Has derrotado a los Hechiceros y Aeryn se ha sacrificado para cerrar el portal Void. #LAST#", "_t")
t("#LIGHT_GREEN#* You defeated the Sorcerers and sacrificed yourself to close the Void portal.#LAST#", "#LIGHT_GREEN#* Has derrotado a los Hechiceros y te has sacrificado para cerrar el portal Void. #LAST#", "_t")
t("Endgame", "Endgame", "_t")
t("#LIGHT_RED#As you enter the level you hear a familiar voice.", "#LIGHT_RED#A medida que entras al nivel escuchas una voz familiar.", "logPlayer")
...
t("", "", "_t")
t("The Sorcerers are dead, and the Orc Pride lies in ruins, thanks to your efforts.", "Los Hechiceros están muertos, y el Orc Pride estás en ruinas, gracias a sus esfuerzos.", "_t")
t("Your patron's plan worked. As your body was crushed by the raw forces of the void portal it opened wide. In an instant the connection was made and waves of heat came through.", "El plan de tu patrón funcionó. A medida que tu cuerpo fue aplastado por las fuerzas crudas del portal de vacío se abrió ampliamente. En un instante se hizo la conexión y las olas de calor pasaron.", "_t")
t("The mad sun brought forth all its power through the portal, turning the High Peak into a giant searing needle!", "¡El sol loco sacó todo tu poder a través del portal, convirtiendo el pico alto en una aguja gigante!", "_t")
...
t("She sadly agreed and ran her sword through you, enabling you to do the last sacrifice you could for the world.", "Ella estuvo tristemente de acuerdo y corrió tu espada a través de ti, permitiéndote hacer el último sacrificio que podías por el mundo.", "_t")
