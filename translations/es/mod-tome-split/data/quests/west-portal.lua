-- mod-tome/data/quests/west-portal.lua
-- Total: 14 cadenas
-- Estado: ⏳ Pendiente
...
t("Zemekkys in the Gates of Morning can build a portal back to your homeland for you.", "Zemekkys en las puertas de la mañana puedes construir un portal de vuelta a tu patria para tú.", "_t")
t("#LIGHT_GREEN#* You have found a Blood-Runed Athame.#WHITE#", "#LIGHT_GREEN# # Has encontrado un Athame en Sangre. #WHITE#", "_t")
...
t("Zemekkys points to the location of Vor Armoury on your map.", "Zemekkys apunta a la ubicación de Vor Armoury en tu mapa.", "logPlayer")
t("Zemekkys points to the location of Briagh's lair on your map.", "Zemekkys apunta a la ubicación de la guarida de Briagh en tu mapa.", "logPlayer")
