-- mod-tome/data/quests/lightning-overload.lua
-- Total: 11 cadenas
-- Estado: ⏳ Pendiente
...
t(" * You have learned the real threat comes from a rogue Archmage, a Tempest. You have been shown a secret entrance to his stronghold.", "* Has aprendido que la verdadera amenaza viene de un Arzobispo pícaro, una Tempestad. Se te ha mostrado una entrada secreta a tu fortaleza.", "_t")
