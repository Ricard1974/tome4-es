-- mod-tome/data/quests/keepsake.lua
-- Total: 32 cadenas
-- Estado: ⏳ Pendiente
...
t("You have found a small iron acorn which you keep as a reminder of your past.", "Tú ha encontrado un pequeño acornio de hierro que tú mantiene como un recordatorio de tu pasado.", "_t")
...
t("Kyless, the one who brought the curse, is dead by your hand.", "Kyless, el que trajo la maldición, estás muerto por tu mano.", "_t")
t("Berethh is dead, may he rest in peace.", "Berethh estás muerto, que descanse en paz.", "_t")
...
t("#LIGHT_GREEN#You need to find Berethh, the last person who may be able to help you.", "#LIGHT_GREEN# Necesitas encontrar a Berethh, la última persona que pueda ayudarte.", "_t")
...
t("#LIGHT_GREEN#You may have to revist your past to unlock some secret buried there.", "#LIGHT_GREEN#Tú puedes tener que reactivar tu pasado para desbloquear algún secreto enterrado allí.", "_t")
...
t("#VIOLET#Kyless is dead.", "#VIOLET#Kyless estás muerto.", "logPlayer")
t("Berethh", "Berethh", "_t")
t("#VIOLET#Berethh lies dead.", "#VIOLET#Berethh estás muerto.", "logPlayer")
