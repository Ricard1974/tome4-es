-- mod-tome/data/chats/yeek-wayist.lua
-- Total: 14 cadenas
-- Estado: ⏳ Pendiente
...
t("Thank the Way. This... thing... would have killed me.", "Gracias al Camino. Esta... cosa... me habría matado.", "_t")
t("The Way sent me to explore this side of the tunnel.", "El Camino me envió a explorar este lado del túnel.", "_t")
t("Yes, me too. We should split up to cover more ground.", "Sí, yo también. Deberíamos separarnos para cubrir más terreno.", "_t")
t("Farewell. We are the Way, always.", "Adiós. Somos el Camino, siempre.", "_t")
