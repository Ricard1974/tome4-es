-- mod-tome/data/talents/gifts/antimagic.lua
-- Total: 9 cadenas
-- Estado: ⏳ Pendiente
...
t(" #GREEN#Antimagic Adept:  #LAST#4 magical sustains from the target will be removed.", "#GREEN# Antimagic Adept: #LAST#4 magic sustains from the target will be removed.", "_t")
