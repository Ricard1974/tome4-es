...
t("Deals %d physical damage, knocking the target back.", "Tratos   PH0   daño físico, devolviendo el objetivo.", "tformat")
t("Glyph of Fatigue", "Glifo of Fatigue", "talent name")
t("glyph of fatigue", "glifo de fatiga", "_t")
t("Slows (%d%%) for 5 turns.", "Lentas por 5 vueltas.", "tformat")
