-- mod-tome/data/talents/celestial/darkside.lua
-- Total: 7 cadenas
-- Estado: ⏳ Pendiente
...
t("%s's teleportation fizzles!", "¡Las boquillas de teletransportación!%s", "logSeen")
t("%s emerges from the darkness!", "%s  emerge de la oscuridad!", "logSeen")
