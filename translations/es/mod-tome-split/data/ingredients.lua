...
t("If you've the means to eliminate the little venom problem, these make miraculous instant drink-chilling straws.", "Si tú tienes los medios para eliminar el pequeño problema del veneno, estos hacen pajitas milagrosas instantáneas.", "_t")
...
t("Ice Wyrms lose teeth fairly often, so you might get lucky and not have to do battle with one. But dress warm just in case.", "Hielo Wyrms pierdes los dientes bastante a menudo, así que podrías tener suerte y no tener que luchar con uno. Pero vestido caliente por si acaso.", "_t")
...
t("Keep this stuff well away from your campfire unless you want me to have to find a new, more alive adventurer.", "Mantenga esto lejos de tu fogata a menos que quiera que tenga que encontrar un nuevo aventurero más vivo.", "_t")
...
t("They're creatures of pure flame, and likely of extraplanar origin, but the ash of objects consumed by their fire has remarkable properties.", "Son criaturas de llama pura, y probablemente de origen extraplanar, pero la ceniza de los objetos consumidos por tu fuego tienes propiedades notables.", "_t")
