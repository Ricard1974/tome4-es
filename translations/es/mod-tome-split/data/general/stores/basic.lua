-- mod-tome/data/general/stores/basic.lua
-- Total: 25 cadenas
-- Estado: ⏳ Pendiente
...
t("axe smith", "herrero de hachas", "entity name")
t("mindstar collector", "coleccionista de estrellas mentales", "entity name")
t("mace smith", "herrero de mazas", "entity name")
...
t("rune store", "tienda de runas", "entity name")
t("gem store", "joyería", "entity name")
t("tool store", "tienda de herramientas", "entity name")
t("staves and wands store", "tienda de bastones y varitas", "entity name")
