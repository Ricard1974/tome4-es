-- mod-tome/data/general/objects/2hswords.lua
-- Total: 14 cadenas
-- Estado: ⏳ Pendiente
...
t("dwarven-steel greatsword", "gran espada enano-esquel", "entity name")
t("d.steel", "ac.dw", "entity short_name")
t("stralite greatsword", "estralite greatsword", "entity name")
t("stralite", "estralita", "entity short_name")
t("voratun greatsword", "voratun gran espada", "entity name")
