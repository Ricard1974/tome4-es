-- mod-tome/data/general/objects/wands.lua
-- Total: 14 cadenas
-- Estado: ⏳ Pendiente
...
t("yew wand", "#", "entity name")
t("yew", "tejo", "entity short_name")
t("elven-wood wand", "varita de madera de elven-wood", "entity name")
t("e.wood", "madera élfica", "entity short_name")
t("dragonbone wand", "hueso de dragón varita", "entity name")
