-- mod-tome/data/general/objects/maces.lua
-- Total: 14 cadenas
-- Estado: ⏳ Pendiente
...
t("Blunt and deadly.", "Desenfrenado y mortal.", "_t")
...
t("dwarven-steel mace", "enano de estela mace", "entity name")
t("d.steel", "ac.dw", "entity short_name")
t("stralite mace", "estralite mace", "entity name")
t("stralite", "estralita", "entity short_name")
t("voratun mace", "voratún maza", "entity name")
