-- mod-tome/data/general/npcs/feline.lua
-- Total: 10 cadenas
-- Estado: ⏳ Pendiente
...
t("feline", "felino", "entity subtype")
t("snow cat", "gato de nieve", "entity name")
t("A large cat with a grey fur matted with black.", "Un gato grande con una piel gris mate con negro.", "_t")
t("panther", "pantera", "entity name")
t("A large black cat, slender and muscular.", "Un gato negro grande, delgado y musculoso.", "_t")
