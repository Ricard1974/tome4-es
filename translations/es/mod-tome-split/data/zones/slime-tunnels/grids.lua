-- mod-tome/data/zones/slime-tunnels/grids.lua
-- Total: 15 cadenas
-- Estado: ⏳ Pendiente
...
t("The way forward is blocked. There must be some way around here to unlock those doors.", "El camino a seguir estás bloqueado. Debe haber alguna manera de abrir esas puertas.", "_t")
