...
t("You have %d stat point(s) to spend. Press p to use them.", "Usted tiene  %d    punto(s) para gastar. Presione p para usarlos.", "logPlayer")
t("You have %d class talent point(s) to spend. Press p to use them.", "Usted tiene  %d   puntos de talento de clase para gastar. Presione p para usarlos.", "logPlayer")
t("You have %d generic talent point(s) to spend. Press p to use them.", "Usted tiene  %d    puntos genéricos de talento para gastar. Presione p para usarlos.", "logPlayer")
