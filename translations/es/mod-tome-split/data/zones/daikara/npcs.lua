-- mod-tome/data/zones/daikara/npcs.lua
-- Total: 11 cadenas
-- Estado: ⏳ Pendiente
...
t("Varsha the Writhing", "Varsha la armadura", "entity name")
...
t("A huge and heavily-scarred orc with a gigantic sword. His helm is fashioned from a dragon's skull.", "Un enorme orco muy escarado con una espada gigante. Tu timón estás modelado del cráneo de un dragón.", "_t")
