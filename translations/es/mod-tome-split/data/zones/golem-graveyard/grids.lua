-- mod-tome/data/zones/golem-graveyard/grids.lua
-- Total: 9 cadenas
-- Estado: ⏳ Pendiente
...
t("It seems that your %s is made to fit inside the empty eye socket of Atamathon. This is probably very unwise.", "Parece que tu  %s  está hecho para encajar dentro de la toma de ojos vacía de Atamathon. Esto es probablemente muy insensato.", "tformat")
