-- mod-tome/data/zones/ruined-dungeon/grids.lua
-- Total: 22 cadenas
-- Estado: ⏳ Pendiente
...
t("The orb is covered in dust.", "El orbe estás cubierto de polvo.", "_t")
...
t("The orb is icy to the touch.", "El orb estás helado al tacto.", "_t")
t("Time seems to slow down around the orb.", "El tiempo parece disminuir alrededor del orbe.", "_t")
t("Your mind is filled with strange thoughts as you approach the orb.", "Tu mente estás llena de pensamientos extraños mientras te acercas al orbe.", "_t")
t("The orb seems to corrupt all it touches.", "El orbe parece corromper todo lo que toca.", "_t")
t(" Do you touch it?", "¿Lo tocas?", "_t")
