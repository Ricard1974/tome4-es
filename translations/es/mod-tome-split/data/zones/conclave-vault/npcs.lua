-- mod-tome/data/zones/conclave-vault/npcs.lua
-- Total: 12 cadenas
-- Estado: ⏳ Pendiente
...
t("ogric abomination", "abominación ógrica", "entity name")
t("This ogre seems to have tried to graft golem parts on its own body. To various interresting results.", "Este ogro parece haber intentado injertar partes de golem en tu propio cuerpo. A diversos resultados interrelacionados.", "_t")
