-- mod-tome/data/zones/infinite-dungeon/objects.lua
-- Total: 19 cadenas
-- Estado: ⏳ Pendiente
...
t("This potent elixir can give insights into martial combat to those unlucky enough to ignore the basics.", "Este potente elixir puedes dar información sobre el combate marcial a aquellos lo suficientemente desafortunados para ignorar los fundamentos.", "_t")
...
t("This potent elixir extracted from a powerful wyrm can grant the power to repel arcane forces.", "Este potente elixir extraído de un poderoso wyrm puedes otorgar el poder para repeler las fuerzas arcanas.", "_t")
t("Antimagic", "Antimagia", "_t")
t("Quaffing this potion will grant you access to the antimagic talents but at the cost of all access to runes, arcane items and spells.", "Cuarenta de esta poción te otorgará acceso a los talentos antimagicos pero a costa de todo el acceso a runas, artículos arcanos y hechizos.", "_t")
t("You cannot use your %s anymore; it is tainted by magic.", "Ya no puedes usar tu %s; estás manchada por la magia.", "logPlayer")
