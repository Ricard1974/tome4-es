-- mod-tome/data/zones/rak-shor-pride/npcs.lua
-- Total: 14 cadenas
-- Estado: ⏳ Pendiente
...
t("A towering creature, made from the bones of countless bodies. An aura of flame billows from within its chest.", "Una criatura imponente, hecha de los huesos de innumerables cuerpos. Un aura de llamas se billows de dentro de tu pecho.", "_t")
t("Arch Zephyr", "Arch Zephyr", "entity name")
t("The robes of this ancient vampire billow with intense winds. Bolts of lightning arc along its body. In its hand it holds a bow, electricity streaking across it.", "Las túnicas de este antiguo billow vampiro con vientos intensos. Bolts of lightning arc along its body. En tu mano sostiene un arco, la electricidad que se extiende a través de él.", "_t")
