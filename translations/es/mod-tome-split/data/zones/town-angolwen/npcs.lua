-- mod-tome/data/zones/town-angolwen/npcs.lua
-- Total: 20 cadenas
-- Estado: ⏳ Pendiente
...
t("A tall, pale woman dressed in a revealing silk robe. Her gaze is so intense it seems to burn.", "Una mujer alta y pálida vestida con un vestido de seda revelador. Tu mirada es tan intensa que parece quemar.", "_t")
t("Remove @himher@!", "Quitar @himher@!", "_t")
t("#GOLD#Linaniil concentrates her formidable will to restore her body!", "#GOLD#Linaniil concentra tu formidable voluntad de restaurar tu cuerpo!", "saySimple")
t("shalore", "shalore", "entity subtype")
t("Archmage Tarelion", "Archmage Tarelion", "entity name")
t("A tall Shalore in a flowing robe, he looks calm and at peace, but you can feel his tremendous power.", "Un Shalore alto en una bata que fluye, se ve calmado y en paz, pero puedes sentir tu enorme poder.", "_t")
