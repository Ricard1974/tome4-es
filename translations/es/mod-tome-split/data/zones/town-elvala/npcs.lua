-- mod-tome/data/zones/town-elvala/npcs.lua
-- Total: 11 cadenas
-- Estado: ⏳ Pendiente
...
t("A tall Elf, his skin covered in runes.", "Un Elfo alto, tu piel cubierta de escorrentías.", "_t")
t("giant", "gigante", "entity type")
t("ogre", "ogro", "entity subtype")
t("ogre rune-spinner", "ogro rune-spinner", "entity name")
t("A towering ogre guard, her skin covered in runes.", "Una imponente guardia de ogro, tu piel cubierta de runas.", "_t")
