-- mod-tome/data/zones/shertul-fortress/grids.lua
-- Total: 26 cadenas
-- Estado: ⏳ Pendiente
...
t("The farportal is broken and will not be usable anymore.", "El farportal estás roto y ya no será usable.", "_t")
t("The fortress does not have enough energy to power a trip through the portal.", "La fortaleza no tienes suficiente energía para hacer un viaje a través del portal.", "_t")
...
t("#VIOLET#As %s falls you notice a portal appearing.", "#VIOLET#As %s se nota que aparece un portal.", "logSeen")
