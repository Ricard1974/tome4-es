-- mod-tome/data/zones/murgol-lair/npcs.lua
-- Total: 13 cadenas
-- Estado: ⏳ Pendiente
...
t("naga tidewarden", "guardamareas naga", "entity name")
t("naga tidecaller", "invocamareas naga", "entity name")
