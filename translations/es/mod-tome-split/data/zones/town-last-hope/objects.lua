-- mod-tome/data/zones/town-last-hope/objects.lua
-- Total: 12 cadenas
-- Estado: ⏳ Pendiente
...
t("The Diaries of King Toknor the Brave (%d)", "Los Diarios del Rey Toknor el Brave ( %d )", "tformat")
...
t("the Pale King part %s", "la parte de Pale King %s", "tformat")
t("one", "uno", "_t")
t("two", "dos", "_t")
