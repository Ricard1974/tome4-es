-- mod-tome/data/zones/ardhungol/objects.lua
-- Total: 9 cadenas
-- Estado: ⏳ Pendiente
...
t("shoot a bolt of spydric poison out to range %d, dealing %0.2f nature damage (based on Magic) over %d turns while rendering the target unable to move", "disparar un tornillo de veneno espídrico a rango %d, tratando %0.2f daño natural (basado en Magic) sobre %d gira mientras que el objetivo no puedes moverse", "tformat")
