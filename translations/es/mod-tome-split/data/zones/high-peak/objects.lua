...
t("absorb the essence (ignoring resistance and bypassing most defenses) of a target in range %d, draining 30%% of its life and increasing your own damage by 30%% for %d turns", "absorber la esencia (ignorando la resistencia y superando la mayoría de las defensas) de un objetivo en rango %d, drenando 30%% de tu vida y aumentando tu propio daño a 30%% para turnos %d", "tformat")
