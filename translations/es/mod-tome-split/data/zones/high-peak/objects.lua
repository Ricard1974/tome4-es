-- mod-tome/data/zones/high-peak/objects.lua
-- Total: 17 cadenas
-- Estado: ⏳ Pendiente
...
t("ominous, dark runed staff", "bastón oscuro y siniestro con runas", "_t")
t("absorb the essence (ignoring resistance and bypassing most defenses) of a target in range %d, draining 30%% of its life and increasing your own damage by 30%% for %d turns", "absorber la esencia (ignorando la resistencia y superando la mayoría de las defensas) de un objetivo en rango  %d , drenando el 30% de su vida y aumentando su propio daño en un 30%%%% para  %d vueltas", "tformat")
t("was absorbed by the %s held by %s", "fue absorbido por el  %s  sostenido por  %s ", "tformat")
t("#Source# brandishes %s %s, absorbing the essence of #target#!", "#Source# brandishes  %s   %s , absorbiendo la esencia de #target#!", "logCombat")
t("#ORCHID# %d essence drain#LAST#", "#ORCHID#  %d  esencial drain#LAST#", "tformat")
