-- mod-tome/data/zones/high-peak/grids.lua
-- Total: 18 cadenas
-- Estado: ⏳ Pendiente
...
t("#LIGHT_BLUE#You use the orb on the portal, shutting it down easily.", "#LIGHT_BLUE#Usas el orbe en el portal, cerrándolo fácilmente.", "logPlayer")
t("%s (disabled)", "%s (discapacitado)", "tformat")
