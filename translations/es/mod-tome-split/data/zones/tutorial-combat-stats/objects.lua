-- mod-tome/data/zones/tutorial-combat-stats/objects.lua
-- Total: 12 cadenas
-- Estado: ⏳ Pendiente
...
t("A finely-wrought helmet that increases your Accuracy by 6.", "Un casco bien hecho que aumentas tu precisión por 6.", "_t")
