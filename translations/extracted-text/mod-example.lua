...
tDef(260, "NB: %d", "log", true) -- 
tDef(331, "There is no way out of this level here.", "log", true) -- 
tDef(436, "Saving game...", "log", true) -- 


------------------------------------------------
section "mod-example/class/Grid.lua"



------------------------------------------------
section "mod-example/class/NPC.lua"
...
tDef(107, "taken damage", "_t", true) -- 
tDef(112, "LOW HEALTH!", "_t", true) -- 
tDef(139, "#00ff00#Talent %s is ready to use.", "log", true) -- 
tDef(146, "LEVEL UP!", "_t", true) -- 
tDef(147, "#00ffff#Welcome to level %d.", "log", true) -- 


------------------------------------------------
section "mod-example/class/interface/Combat.lua"
...
------------------------------------------------
section "mod-example/data/gfx/particles/acid.lua"



------------------------------------------------
section "mod-example/data/rooms/pilar.lua"



------------------------------------------------
section "mod-example/data/rooms/simple.lua"
...
------------------------------------------------
section "mod-example/data/timed_effects.lua"



------------------------------------------------
section "mod-example/data/zones/dungeon/grids.lua"



------------------------------------------------
section "mod-example/data/zones/dungeon/npcs.lua"



------------------------------------------------
section "mod-example/data/zones/dungeon/objects.lua"



------------------------------------------------
section "mod-example/data/zones/dungeon/traps.lua"
...
tDef(21, "Example Module for T-Engine4", "init.lua long_name", true) -- 
